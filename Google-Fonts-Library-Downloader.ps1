    ...
    foreach ($font in $fontFiles) {
        try {
            ...
            while ($true) {
                ...
                $expectedRegistryValue = if ($normalizedScope -eq "allusers") { $targetFileName } else { $targetPath }
                if ($existingValue -eq $expectedRegistryValue) {
                    break
                }
            ...
            $registryValue = if ($normalizedScope -eq "allusers") { $targetFileName } else { $targetPath }
